...
class EventOutcomeControllerTest {
  ...
  @InjectMocks private EventOutcomeController controller;

  @Mock private EventOutcomeProducerService service;
  ...
  @Test
  void publishOutcome_givenValidDto_whenPostRequest_thenReturnsOkAndCallsService()
      throws Exception {
    // GIVEN
